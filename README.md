...
The markoffchains folder contains the package files and the pdf file `markoffchains_0.0.0.9000.pdf` contains brief descriptions of the package functions.
